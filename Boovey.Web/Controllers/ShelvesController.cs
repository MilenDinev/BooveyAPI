namespace Boovey.Web.Controllers
{
    ...
    public class ShelvesController : BooveyBaseController
    {
        ...
        private readonly IContextAccessorServices<Shelve> shelvesAccessorService;
        private readonly IMapper mapper;
        public ShelvesController(IShelveService shelveService, IContextAccessorServices<Shelve> shelvesAccessorService, IMapper mapper, IUserService userService) : base(userService)
        {
