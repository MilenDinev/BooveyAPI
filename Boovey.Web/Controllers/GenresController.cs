namespace Boovey.Web.Controllers
{
    ...
    public class GenresController : BooveyBaseController
    {
        ...
        public GenresController(IGenreService genreService, ISearchService<Entity> searchService, IMapper mapper, IUserService userService) : base(userService)
        {
        ...
        public async Task<ActionResult> Create(CreateGenreModel genreInput)
        {
            ...
            var alreadyExists = await this.searchService.ContainsActiveByStringAsync(genreInput.Title);
            if (alreadyExists)
