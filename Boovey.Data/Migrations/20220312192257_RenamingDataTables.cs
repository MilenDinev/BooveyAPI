...
{
    public partial class RenamingDataTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookShelves", x => new { x.BookId, x.ShelveId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookShelves_Shelves_ShelveId",
                        column: x => x.ShelveId,
